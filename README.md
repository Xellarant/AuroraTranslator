...
- over-picked first-party choice states now surface explicit `over-selected-choice` warnings instead of silently passing through
...
- committed character-state fixtures now cover baseline, bond/text-choice, early fighter, elf darkvision, a first-party granted-spell scenario, PHB 2024 replacement-style feature picks, a first-party oversubscribe warning scenario, first-party fly/climb/swim movement scenarios, and a companion burrow-speed scenario
